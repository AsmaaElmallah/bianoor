...
class _EmotionalPlayerScreenState extends ConsumerState<EmotionalPlayerScreen> {
  final _audio = AudioPlayer();
  Timer? _timer;
  StreamSubscription<PlayerState>? _audioSub;
  StreamSubscription<Duration>? _positionSub;

  List<EmotionalRoundStep> _steps = [];
  int _stepIndex = 0;
  bool _loading = true;
  ...
  EmotionalRoundStep? get _current => _stepIndex < _steps.length ? _steps[_stepIndex] : null;
                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          TactileClayCard(
                            color: const Color(0xFFE8A0B0).withValues(alpha: 0.45),
                            child: Row(
                              children: [
                                ClipRRect(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 4),
                                      Text(
                                        'لتعزيز التفاعل الاجتماعي — على مسافة مريحة من وجهه',
        ...
        children: List.generate(total, (i) {
          ...
          return AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: done || active ? const Color(0xFFE8A0B0) : AppColors.outlineVariant,
