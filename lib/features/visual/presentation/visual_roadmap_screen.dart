...
/// خارطة منهج التحفيز (Stitch 3d_1tp).
      ...
      body: ListView(
        ...
        children: [
          TactileClayCard(
            ...
            child: Column(
              children: [
                const Icon(Symbols.visibility, size: 56, color: AppColors.secondary, fill: 1),
                ...
                Text(
                  '$visualLessonCount درساً · $visualExpectedGlobalSlideCount شريحة · ينتهي المحتوى الجديد يوم $visualLastNewContentDay',
          ...
          const _PhaseCard(
            number: '٥+',
            title: 'دروس ٥–٣٠',
            days: '٥٦–$visualLastNewContentDay (٥ أيام/درس)',
            reps: '٥ مرات يومياً',
            focus: '١–١.٥ دقيقة ثم ١ دقيقة',
            slides: '١٠ شرائح (الدرس ٣٠ = ٧)',
            highlight: true,
          ),
          const SizedBox(height: 12),
          ...visualJourneyStages.map(
            (s) => Padding(
              ...
              child: TactileClayCard(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      s.dayEnd >= 9999
                          ? 'من يوم $visualReviewCycleStartDay'
                          : 'حتى يوم ${s.dayEnd}',
