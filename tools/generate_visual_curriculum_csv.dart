...
import 'package:bayanour/features/visual/domain/visual_curriculum_schedule.dart';
...
void main() {
  ...
  for (var day = 1; day <= curriculumProgramTotalDays; day++) {
    final lesson = visualLessonNumberForDay(day);
    final range = visualLessonSlideRange(lesson);
    final rules = curriculumRulesForDay(day, lastNewContentDay: visualLastNewContentDay);
    final phase = visualPhaseCodeForDay(day);
  ...
  final out = File('docs/visual_curriculum_730_days.csv');
